# Nodejs API Project Folder Structure
...
```
cd nodejs-api-project-folder-structure
git remote add origin https://github.com/mochamadhaikal/nodejs-api-project-folder-structure.git
git branch -M master
